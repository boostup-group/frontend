        ...
        <div class="flex flex-wrap -mx-4 align-items-center">
          ...
          <div class="w-full lg:w-1/2 px-4">
            <div class="lg:ml-auto">
              <p class="text-lg font-semibold text-black mb-10">Get insider access to our company by subscribing to our newsletter and stay informed about our products, services, and initiatives.</p>
              {!isSuccess && (
